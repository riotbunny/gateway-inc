...
export default function FormModal({ onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[150] bg-slate-950/90 backdrop-blur-sm flex flex-col items-center justify-center p-3 sm:p-4 font-sans overflow-y-auto">
      <button 
        onClick={onClose}
        className="absolute top-4 right-4 z-[200] text-slate-400 hover:text-white bg-slate-800/80 p-2 rounded-full transition-colors"
      >
        <X size={24} />
      </button>
        ...
        <div className="p-4 sm:p-8">
          ...
          {isDiagnosticRunning ? (
            ...
            <div className="text-center py-2 animate-in fade-in duration-500">
              ...
              <p className="text-slate-200 text-sm font-medium mb-4 px-1 leading-relaxed">
              ...
              {step === 1 && (
                <div className="space-y-4 animate-in fade-in duration-300">
                  ...
                  <div>
                    ...
                    <div className="mt-2 text-center flex items-center justify-center text-[11px] text-slate-400 font-medium">
